...
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.0-preview/email_auth.zkey --output ./email_auth.zkey
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.0-preview/email_auth.wasm --output ./email_auth.wasm
# unzip params.zip
