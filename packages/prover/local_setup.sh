...
mkdir email_auth_cpp && cd email_auth_cpp
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/Makefile --output ./Makefile
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/calcwit.cpp --output ./calcwit.cpp
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/calcwit.hpp --output ./calcwit.hpp
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/circom.hpp --output ./circom.hpp
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/email_auth.cpp --output ./email_auth.cpp
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/email_auth.dat --output ./email_auth.dat
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/fr.asm --output ./fr.asm
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/fr.cpp --output ./fr.cpp
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/fr.hpp --output ./fr.hpp
curl https://storage.googleapis.com/circom-ether-email-auth/v0.1.1-preview/email_auth_cpp/main.cpp --output ./main.cpp
# unzip params.zip
