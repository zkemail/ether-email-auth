...
pub mod email_auth {
            ...
            events: ::core::convert::From::from([
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Event {
                        name: ::std::borrow::ToOwned::to_owned("DKIMRegistryUpdated",),
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Event {
                        name: ::std::borrow::ToOwned::to_owned("SubjectTemplateDeleted",),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::EventParam {
                            name: ::std::borrow::ToOwned::to_owned("templateId"),
                            kind: ::ethers::core::abi::ethabi::ParamType::Uint(256usize,),
                            indexed: true,
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Event {
                        name: ::std::borrow::ToOwned::to_owned("SubjectTemplateInserted",),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::EventParam {
                            name: ::std::borrow::ToOwned::to_owned("templateId"),
                            kind: ::ethers::core::abi::ethabi::ParamType::Uint(256usize,),
                            indexed: true,
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Event {
                        name: ::std::borrow::ToOwned::to_owned("SubjectTemplateUpdated",),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::EventParam {
                            name: ::std::borrow::ToOwned::to_owned("templateId"),
                            kind: ::ethers::core::abi::ethabi::ParamType::Uint(256usize,),
                            indexed: true,
    ...
    impl<M: ::ethers::providers::Middleware> EmailAuth<M> {
        ...
        pub fn dkim_registry_updated_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, DkimregistryUpdatedFilter>
        {
            self.0.event()
        }
        ...
        pub fn email_authed_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, EmailAuthedFilter>
        {
            self.0.event()
        }
        ...
        pub fn subject_template_deleted_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, SubjectTemplateDeletedFilter>
        {
            self.0.event()
        }
        ...
        pub fn subject_template_updated_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, SubjectTemplateUpdatedFilter>
        {
            self.0.event()
        }
        ...
        pub fn timestamp_check_enabled_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, TimestampCheckEnabledFilter>
        {
            self.0.event()
        }
    ...
    #[ethevent(
        name = "SubjectTemplateDeleted",
        abi = "SubjectTemplateDeleted(uint256)"
    )]
    ...
    #[ethevent(
        name = "SubjectTemplateUpdated",
        abi = "SubjectTemplateUpdated(uint256)"
    )]
    ...
    impl ::core::fmt::Display for EmailAuthEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DkimregistryUpdatedFilter(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::TimestampCheckEnabledFilter(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::ethers::core::abi::AbiDecode for EmailAuthCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <InitDKIMRegistryCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::InitDKIMRegistry(decoded));
            }
            if let Ok(decoded) = <InitVerifierCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for EmailAuthCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::InitDKIMRegistry(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::InitVerifier(element) => ::ethers::core::abi::AbiEncode::encode(element),
