...
template ForcedSubjectRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		and[31][i] = AND();
		and[31][i].a <== states[i][23];
		and[31][i].b <== and[30][i].out;
		multi_or[2][i] = MultiOR(5);
		multi_or[2][i].in[0] <== and[25][i].out;
		multi_or[2][i].in[1] <== and[26][i].out;
		multi_or[2][i].in[2] <== and[28][i].out;
		multi_or[2][i].in[3] <== and[29][i].out;
		multi_or[2][i].in[4] <== and[31][i].out;
		...
		multi_or[3][i].in[0] <== and[32][i].out;
		multi_or[3][i].in[1] <== and[33][i].out;
		states[i+1][21] <== multi_or[3][i].out;
		eq[31][i] = IsEqual();
		eq[31][i].in[0] <== in[i];
		eq[31][i].in[1] <== 225;
		eq[32][i] = IsEqual();
		...
		multi_or[7][i].in[0] <== and[40][i].out;
		multi_or[7][i].in[1] <== and[41][i].out;
		states[i+1][23] <== multi_or[7][i].out;
		eq[62][i] = IsEqual();
		eq[62][i].in[0] <== in[i];
		eq[62][i].in[1] <== 240;
		and[42][i] = AND();
		...
		states[i+1][24] <== multi_or[8][i].out;
		eq[63][i] = IsEqual();
		eq[63][i].in[0] <== in[i];
		eq[63][i].in[1] <== 241;
		eq[64][i] = IsEqual();
		...
		multi_or[10][i].in[0] <== and[44][i].out;
		multi_or[10][i].in[1] <== and[45][i].out;
		states[i+1][25] <== multi_or[10][i].out;
		eq[66][i] = IsEqual();
		eq[66][i].in[0] <== in[i];
		eq[66][i].in[1] <== 244;
		and[46][i] = AND();
