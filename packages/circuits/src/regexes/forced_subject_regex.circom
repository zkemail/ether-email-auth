...
template ForcedSubjectRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		lt[13][i].in[1] <== 191;
		and[25][i] = AND();
		and[25][i].a <== lt[12][i].out;
		and[25][i].b <== lt[13][i].out;
		and[26][i] = AND();
		and[26][i].a <== states[i][15];
		and[26][i].b <== and[25][i].out;
		and[27][i] = AND();
		and[27][i].a <== states[i][16];
		and[27][i].b <== and[14][i].out;
		eq[26][i] = IsEqual();
		eq[26][i].in[0] <== in[i];
		eq[26][i].in[1] <== 128;
		eq[27][i] = IsEqual();
