...
template ForcedSubjectRegex(msg_bytes) {
	...
	signal states_tmp[num_bytes+1][30];
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[10] <== eq[28][i].out;
		multi_or[0][i].in[11] <== eq[29][i].out;
		...
		lt[3][i].in[1] <== 191;
		and[23][i] = AND();
		and[23][i].a <== lt[2][i].out;
		and[23][i].b <== lt[3][i].out;
		and[24][i] = AND();
		...
		multi_or[1][i].in[2] <== and[24][i].out;
		...
		multi_or[2][i].in[2] <== and[29][i].out;
		multi_or[2][i].in[3] <== and[30][i].out;
		multi_or[2][i].in[4] <== and[32][i].out;
		states[i+1][21] <== multi_or[2][i].out;
		eq[30][i] = IsEqual();
		eq[30][i].in[0] <== in[i];
		eq[30][i].in[1] <== 224;
		and[33][i] = AND();
		and[33][i].a <== states[i][19];
		and[33][i].b <== eq[30][i].out;
		and[34][i] = AND();
		and[34][i].a <== states[i][20];
		and[34][i].b <== eq[30][i].out;
		multi_or[3][i] = MultiOR(2);
		multi_or[3][i].in[0] <== and[33][i].out;
		multi_or[3][i].in[1] <== and[34][i].out;
		states[i+1][22] <== multi_or[3][i].out;
		eq[31][i] = IsEqual();
		eq[31][i].in[0] <== in[i];
		eq[31][i].in[1] <== 225;
		eq[32][i] = IsEqual();
		...
		multi_or[5][i].in[0] <== eq[45][i].out;
		multi_or[5][i].in[1] <== eq[46][i].out;
		...
		states[i+1][23] <== multi_or[6][i].out;
		eq[61][i] = IsEqual();
		eq[61][i].in[0] <== in[i];
		eq[61][i].in[1] <== 237;
		and[41][i] = AND();
		...
		multi_or[9][i].in[0] <== eq[63][i].out;
		multi_or[9][i].in[1] <== eq[64][i].out;
		multi_or[9][i].in[2] <== eq[65][i].out;
		and[45][i].b <== multi_or[9][i].out;
		and[46][i] = AND();
		...
		and[47][i].b <== eq[66][i].out;
		and[48][i] = AND();
		and[48][i].a <== states[i][20];
		and[48][i].b <== eq[66][i].out;
		multi_or[11][i] = MultiOR(2);
		multi_or[11][i].in[0] <== and[47][i].out;
		multi_or[11][i].in[1] <== and[48][i].out;
		...
		from_zero_enabled[i] <== MultiNOR(29)([states_tmp[i+1][1], states_tmp[i+1][2], states[i+1][3], states[i+1][4], states[i+1][5], states[i+1][6], states[i+1][7], states[i+1][8], states[i+1][9], states[i+1][10], states[i+1][11], states[i+1][12], states[i+1][13], states[i+1][14], states[i+1][15], states[i+1][16], states[i+1][17], states[i+1][18], states[i+1][19], states[i+1][20], states[i+1][21], states[i+1][22], states[i+1][23], states[i+1][24], states[i+1][25], states[i+1][26], states[i+1][27], states[i+1][28], states[i+1][29]]);
