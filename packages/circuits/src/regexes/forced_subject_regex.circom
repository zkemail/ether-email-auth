...
template ForcedSubjectRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		states[i+1][12] <== multi_or[0][i].out;
		and[14][i] = AND();
		...
		lt[1][i].in[1] <== 127;
		and[24][i] = AND();
		and[24][i].a <== lt[0][i].out;
		and[24][i].b <== lt[1][i].out;
		eq[20][i] = IsEqual();
		eq[20][i].in[0] <== in[i];
		eq[20][i].in[1] <== 1;
		eq[21][i] = IsEqual();
		...
		lt[3][i].in[1] <== 191;
		and[26][i] = AND();
		and[26][i].a <== lt[2][i].out;
		and[26][i].b <== lt[3][i].out;
		and[27][i] = AND();
		...
		lt[5][i].in[1] <== 223;
		and[29][i] = AND();
		and[29][i].a <== lt[4][i].out;
		and[29][i].b <== lt[5][i].out;
		and[30][i] = AND();
		...
		lt[9][i].in[1] <== 159;
		and[34][i] = AND();
		and[34][i].a <== lt[8][i].out;
		and[34][i].b <== lt[9][i].out;
		and[35][i] = AND();
		...
		multi_or[3][i].in[2] <== and[33][i].out;
		multi_or[3][i].in[3] <== and[35][i].out;
		...
		multi_or[4][i].in[0] <== eq[32][i].out;
		multi_or[4][i].in[1] <== eq[33][i].out;
		multi_or[4][i].in[2] <== eq[34][i].out;
		multi_or[4][i].in[3] <== eq[35][i].out;
		multi_or[4][i].in[4] <== eq[36][i].out;
		multi_or[4][i].in[5] <== eq[37][i].out;
		multi_or[4][i].in[6] <== eq[38][i].out;
		multi_or[4][i].in[7] <== eq[39][i].out;
		multi_or[4][i].in[8] <== eq[40][i].out;
		multi_or[4][i].in[9] <== eq[41][i].out;
		multi_or[4][i].in[10] <== eq[42][i].out;
		multi_or[4][i].in[11] <== eq[43][i].out;
		multi_or[4][i].in[12] <== eq[44][i].out;
		multi_or[4][i].in[13] <== eq[45][i].out;
		...
		multi_or[5][i].in[0] <== eq[46][i].out;
		multi_or[5][i].in[1] <== eq[47][i].out;
		multi_or[5][i].in[2] <== eq[48][i].out;
		multi_or[5][i].in[3] <== eq[49][i].out;
		multi_or[5][i].in[4] <== eq[50][i].out;
		multi_or[5][i].in[5] <== eq[51][i].out;
		multi_or[5][i].in[6] <== eq[52][i].out;
		multi_or[5][i].in[7] <== eq[53][i].out;
		multi_or[5][i].in[8] <== eq[54][i].out;
		multi_or[5][i].in[9] <== eq[55][i].out;
		multi_or[5][i].in[10] <== eq[56][i].out;
		multi_or[5][i].in[11] <== eq[57][i].out;
		multi_or[5][i].in[12] <== eq[58][i].out;
		multi_or[5][i].in[13] <== eq[59][i].out;
		multi_or[5][i].in[14] <== eq[60][i].out;
		multi_or[5][i].in[15] <== eq[61][i].out;
		...
		and[42][i].b <== eq[62][i].out;
		states[i+1][27] <== and[42][i].out;
		eq[63][i] = IsEqual();
		eq[63][i].in[0] <== in[i];
		eq[63][i].in[1] <== 240;
		and[43][i] = AND();
		and[43][i].a <== states[i][22];
		and[43][i].b <== eq[63][i].out;
		...
		multi_or[7][i].in[0] <== eq[64][i].out;
		multi_or[7][i].in[1] <== eq[65][i].out;
		multi_or[7][i].in[2] <== eq[66][i].out;
		and[44][i].b <== multi_or[7][i].out;
