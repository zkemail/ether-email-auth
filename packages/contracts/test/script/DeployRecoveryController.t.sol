...
contract DeployRecoveryControllerTest is Test {
    ...
    function test_run() public {
        ...
        require(vm.envAddress("EMAIL_AUTH_IMPL") != address(0), "EMAIL_AUTH_IMPL is not set");
        require(vm.envAddress("RECOVERY_CONTROLLER") != address(0), "RECOVERY_CONTROLLER is not set");
        require(vm.envAddress("SIMPLE_WALLET") != address(0), "SIMPLE_WALLET is not set");
    }
